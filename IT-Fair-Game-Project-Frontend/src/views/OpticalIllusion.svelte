...
{#if current_question === 0}
    <div id="intro">
        <p>Welcome to the world of optical illusions!</p>
        <p>This short quiz will showcase a few of the most mindblowing illusions known to man.</p>
        <br>
...
{#if current_question - 1 === questions.length}
    <div id="outro">
        <p>That's it!</p>
        <p>Thanks for participating in the our tests. You will receive your score shortly.</p>
        <button on:click>End Test</button>
    </div>
{/if}
